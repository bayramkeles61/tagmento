...
[Tagmento](https://tagmento.com/) is a highly customizable, accessible, and fully-featured tag input component built with Shadcn UI.
...
Tagmento is a forked and updated version of the Emblor package, now fully compatible with Tailwind CSS 4.0 and React 19. This update ensures you can use this powerful tag input component with the latest frontend technologies without compatibility issues.

## About

Tagmento is built on top of the [Input](https://ui.shadcn.com/docs/components/input), [Popover](https://ui.shadcn.com/docs/components/popover), [Command](https://ui.shadcn.com/docs/components/command) and [Dialog](https://ui.shadcn.com/docs/components/dialog) components from [Shadcn UI](https://ui.shadcn.com/).

The documentation page now includes Shadcn UI Registry features, allowing for customization with v0 example code.
    ...
    <section className="z-10 max-w-5xl w-full flex flex-col items-center text-center gap-5">
      <div className="z-10 w-full flex flex-col items-center text-center gap-5">
        ...
        <div className="flex gap-2 mt-1">
          ...
          <Link
            href="https://github.com/YOUR_USERNAME/tagmento"
...
You can find out more about the API and implementation in the [Documentation](https://tagmento.com/). The documentation now includes Shadcn UI Registry features, allowing you to customize components with v0 example code.