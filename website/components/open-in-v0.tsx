    ...
    <TooltipProvider delayDuration={0}>
      <Tooltip>
        <TooltipTrigger asChild>
          ...
          >
            <svg height="16" xmlns="http://www.w3.org/2000/svg" strokeLinejoin="round" viewBox="0 0 16 16" width="16">
              <path
                clipRule="evenodd"
        ...
        <TooltipContent className="text-muted-foreground px-2 py-1 text-xs">Open in v0</TooltipContent>
      </Tooltip>
    </TooltipProvider>
  );
};
