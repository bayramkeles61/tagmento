...
export default function CliCommands({ name }: { name: string }) {
  ...
  const commands = {
    ...
    pnpm: `pnpm dlx shadcn@latest add https://tagmento.com/r/${name}.json`,
    yarn: `npx shadcn@latest add https://tagmento.com/r/${name}.json`,
    bun: `bunx --bun shadcn@latest add https://tagmento.com/r/${name}.json`,
  };
