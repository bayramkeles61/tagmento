---
title: API Reference
description: Detailed documentation of all the properties, types, and options available in the Tagmento tag input component.
---
...
<div className="leading-7 [&amp;:not(:first-child)]:mt-4 text-normal">Clear all tags from the tag input.</div>
...
<div className="leading-7 [&amp;:not(:first-child)]:mt-4 text-normal">Add tags when the input field loses focus.</div>
